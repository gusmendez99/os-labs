/*
HW
Add explanatory comments to the casio_task.c 
and casio_system.c files that understand the purpose and operation 
of this code.
*/
#include <sys/time.h>
#include <signal.h>
...
// task config struct with time params
...
// print every task inside tasks array
...
// clear task config with default values
...
// Gets config of a specific task
...
int main(int argc, char *argv[])
{
	...
	for(i=0;i<casio_tasks_num;i++){
		...
		// Provides info of the casio_tasks if there are any
